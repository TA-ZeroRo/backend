"""
Insert batch 3 campaigns individually to avoid SQL escaping issues
"""
import json
...
# Batch 3 is campaigns 20-29 (index 20-29)
batch_3 = campaigns[20:30]

print(f"Batch 3 campaigns to insert: {len(batch_3)}")
print("\nCampaigns:")
for i, c in enumerate(batch_3, 1):
    print(f"{i}. {c['title']}")
...
print("\n✅ All individual SQL files generated for Batch 3!")
