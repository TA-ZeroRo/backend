...
from .endpoints import campaign, character, community, leaderboard, like, point, users, verification, mission, report
...
router.include_router(mission.router, prefix="/mission", tags=["Mission"])
